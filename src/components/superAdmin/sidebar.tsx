            ...
            <SidebarHeader className="border-b border-gray-100 dark:border-gray-800 p-4">
                <div className="flex items-center space-x-3">
                    ...
                    <div className="overflow-hidden transition-all duration-300" >
                        <h1 className="text-lg font-bold text-gray-900 dark:text-white whitespace-nowrap">Super Admin</h1>
                        <p className="text-xs text-gray-500 dark:text-gray-400 truncate">Manage your platform</p>
                    </div>
                </div>
            </SidebarHeader>
