...
import { iOrder } from "@/models/StoreAdmin/order.model";
  ...
  return (
    <TooltipProvider>
      <div className="space-y-4">
              ...
              <TableBody>
                {filteredOrders.map((order) => (
                  <TableRow key={order._id} className="hover:bg-muted/50">
                    ...
                    <TableCell>
                      <Badge
                        className={`gap-1 px-3 py-1 ${paymentStatusColors[order.payment_status] || "bg-gray-100"}`}
                      >
                    ...
                    <TableCell>
                      <Badge
                        className={`gap-1 px-3 py-1 ${statusColors[order.status] || "bg-gray-100"}`}
                      >
        ...
        >
          <DialogContent className="max-w-2xl invoice-container">
            <DialogHeader>
              <DialogTitle>
                Order #
                {viewingOrder?.order_number || viewingOrder?._id?.slice(-8)}
              </DialogTitle>
              <DialogDescription>
              ...
              <div className="space-y-6">
                ...
                {viewingOrder.tracking_number && (
                  <div className="rounded-lg border p-4">
                    ...
                    <p className="text-sm">
                      Tracking Number: {viewingOrder.tracking_number}
                    </p>
                  </div>
                )}
              </div>
        ...
        <Dialog
          open={!!updatingOrder}
          onOpenChange={() => setUpdatingOrder(null)}
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Order #
                {updatingOrder?.order_number || updatingOrder?._id?.slice(-8)}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
              ...
              <div className="flex justify-between items-start mb-8">
                ...
                <div className="text-right">
                  <p className="font-semibold">
                    Date:{" "}
                    {format(new Date(viewingOrder.created_at), "MMM dd, yyyy")}
                  </p>
                  <p>
                    Status:{" "}
